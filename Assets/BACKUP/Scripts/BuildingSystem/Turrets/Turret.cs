...
public class Turret : MonoBehaviour
{
    ...
    void Shoot()
    {
        GameObject bulletGOOO = (GameObject)Instantiate(bulletPrefab, firePoint.position, firePoint.rotation);
        BulletForTurret bullettt = bulletGOOO.GetComponent<BulletForTurret>();
        if (bullettt != null)
            bullettt.Seek(target);
    }
